---
layout: distill
title: "Policy, World Model Code Generation"
description: "Generative policies, world model rollouts, and using LLMs for robotic code generation (Code as Policies, VoxPoser)."
date: 2026-10-12
future: true
htmlwidgets: true
...
bibliography: 2026-10-12-policy-world-model-code-generation.bib
...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Policy, World Model Code Generation** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Generative policies, world model rollouts, and using LLMs for robotic code generation (Code as Policies, VoxPoser).
...
{% include figure.liquid 
   path="assets/img/2026-10-12-policy-world-model-code-generation/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Policy, World Model Code Generation." 
%}
```
...
- **Problem Framing**: How does Policy, World Model Code Generation overcome the limitations of traditional non-interactive robotics?
