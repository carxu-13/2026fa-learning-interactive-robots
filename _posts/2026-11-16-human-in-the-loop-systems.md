...
{% include figure.liquid 
   path="assets/img/2026-11-16-human-in-the-loop-systems/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Human-in-the-loop Systems." 
%}
```
...
- **Problem Framing**: How does Human-in-the-loop Systems overcome the limitations of traditional non-interactive robotics?
