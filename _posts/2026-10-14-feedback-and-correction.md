...
description: "Interactive policy learning through human interventions, corrective teleoperation, and natural language corrections."
date: 2026-10-14
future: true
htmlwidgets: true
...
bibliography: 2026-10-14-feedback-and-correction.bib
...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Feedback and Correction** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Interactive policy learning through human interventions, corrective teleoperation, and natural language corrections.
...
{% include figure.liquid 
   path="assets/img/2026-10-14-feedback-and-correction/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Feedback and Correction." 
%}
```
...
- **Problem Framing**: How does Feedback and Correction overcome the limitations of traditional non-interactive robotics?
