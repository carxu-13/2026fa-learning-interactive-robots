---
layout: distill
title: "Social Interaction, Cooperation"
description: "Multi-agent coordination, game-theoretic formulations of human-robot teaming, and social conventions in shared workspaces."
date: 2026-11-02
future: true
htmlwidgets: true
...
bibliography: 2026-11-02-social-interaction-cooperation.bib
...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Social Interaction, Cooperation** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Multi-agent coordination, game-theoretic formulations of human-robot teaming, and social conventions in shared workspaces.
...
{% include figure.liquid 
   path="assets/img/2026-11-02-social-interaction-cooperation/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Social Interaction, Cooperation." 
%}
```
...
- **Problem Framing**: How does Social Interaction, Cooperation overcome the limitations of traditional non-interactive robotics?
