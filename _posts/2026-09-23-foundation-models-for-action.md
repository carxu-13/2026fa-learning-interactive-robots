...
{% include figure.liquid 
   path="assets/img/2026-09-23-foundation-models-for-action/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Foundation Models for Action." 
%}
```
...
- **Problem Framing**: How does Foundation Models for Action overcome the limitations of traditional non-interactive robotics?
