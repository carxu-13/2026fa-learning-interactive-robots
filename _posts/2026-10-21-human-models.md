...
layout: distill
title: "Human Models"
description: "Computational human models: Boltzmann rationality, bounded rationality, Theory of Mind, and belief modeling for human-robot interaction."
date: 2026-10-21
future: true
htmlwidgets: true
...
bibliography: 2026-10-21-human-models.bib
...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Human Models** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Computational human models: Boltzmann rationality, bounded rationality, Theory of Mind, and belief modeling for human-robot interaction.
...
{% include figure.liquid 
   path="assets/img/2026-10-21-human-models/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Human Models." 
%}
```
...
- **Problem Framing**: How does Human Models overcome the limitations of traditional non-interactive robotics?
