...
description: "Pre-trained vision foundation models (CLIP, DINO, Segment Anything) and their representations for embodied robotics perception."
date: 2026-09-16
future: true
htmlwidgets: true
...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Foundation Models for Vision** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Pre-trained vision foundation models (CLIP, DINO, Segment Anything) and their representations for embodied robotics perception.
...
{% include figure.liquid 
   path="assets/img/2026-09-16-foundation-models-for-vision/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Foundation Models for Vision." 
%}
```
...
- **Problem Framing**: How does Foundation Models for Vision overcome the limitations of traditional non-interactive robotics?
