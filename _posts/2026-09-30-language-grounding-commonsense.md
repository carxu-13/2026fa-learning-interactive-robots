...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Language Grounding & Commonsense** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Grounding natural language commands into physical environments, spatial relationships, and affordance-aware commonsense reasoning.
...
{% include figure.liquid 
   path="assets/img/2026-09-30-language-grounding-commonsense/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Language Grounding & Commonsense." 
%}
```
...
- **Problem Framing**: How does Language Grounding & Commonsense overcome the limitations of traditional non-interactive robotics?
