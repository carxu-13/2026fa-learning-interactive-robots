---
layout: distill
title: "Intent/Trajectory Prediction"
description: "Forecasting human motion and navigation trajectories in shared physical environments using generative and sequence models."
date: 2026-10-26
future: true
htmlwidgets: true
...
bibliography: 2026-10-26-intent-trajectory-prediction.bib
...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Intent/Trajectory Prediction** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Forecasting human motion and navigation trajectories in shared physical environments using generative and sequence models.
...
{% include figure.liquid 
   path="assets/img/2026-10-26-intent-trajectory-prediction/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Intent/Trajectory Prediction." 
%}
```
...
- **Problem Framing**: How does Intent/Trajectory Prediction overcome the limitations of traditional non-interactive robotics?
