...
description: "Blending human teleoperation and robot autonomy for assistive devices, manipulators, and robotic vehicles."
date: 2026-11-04
future: true
htmlwidgets: true
...
bibliography: 2026-11-04-shared-autonomy.bib
...
This lecture report synthesizes the core concepts, assigned readings, and classroom discussions for the **Shared Autonomy** session in *Learning for Interactive Robots (CS 6501 / CS 4501, Fall 2026)* at the University of Virginia.

> **Key takeaway**: Blending human teleoperation and robot autonomy for assistive devices, manipulators, and robotic vehicles.
...
{% include figure.liquid 
   path="assets/img/2026-11-04-shared-autonomy/overview.png" 
   class="img-fluid rounded z-depth-1" 
   caption="Figure 1: Conceptual overview diagram of Shared Autonomy." 
%}
```
...
- **Problem Framing**: How does Shared Autonomy overcome the limitations of traditional non-interactive robotics?
